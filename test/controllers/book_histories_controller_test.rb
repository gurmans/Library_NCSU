...
class BookHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_history" do
    assert_difference('BookHistory.count') do
      post book_histories_url, params: { book_history: { issueDate: @book_history.issueDate, returnDate: @book_history.returnDate } }
    end
  ...
  test "should update book_history" do
    patch book_history_url(@book_history), params: { book_history: { issueDate: @book_history.issueDate, returnDate: @book_history.returnDate } }
