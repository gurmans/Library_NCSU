...
class LibrariansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create librarian" do
    assert_difference('Librarian.count') do
      post librarians_url, params: { librarian: { bookmarks: @librarian.bookmarks, email: @librarian.email, name: @librarian.name, passwrod: @librarian.passwrod } }
    end
  ...
  test "should update librarian" do
    patch librarian_url(@librarian), params: { librarian: { bookmarks: @librarian.bookmarks, email: @librarian.email, name: @librarian.name, passwrod: @librarian.passwrod } }
